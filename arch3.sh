...
yay -S --mflags --skipinteg --noconfirm mc htop ncdu edk2-ovmf virt-manager qemu dnsmasq ffmpeg yt-dlp mediainfo-gui qtqr startwine qt-heif-image-plugin-git ifuse wireguard-tools wireproxy virtualbox virtualbox-guest-utils
